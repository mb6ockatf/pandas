...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    @staticmethod
    def _get_call_args(
        backend_name: str, data: Series | DataFrame, args, kwargs
    ):
        """
        ...
        if args and isinstance(data, ABCSeries):
            ...
            keyword_args = ", ".join(
                [
                    f"{name}={value!r}"
                    for (name, _), value in zip(arg_def, args)
                ]
            )
            msg = (
    ...
    def kde(
        self,
        bw_method: (
            Literal["scott", "silverman"] | float | Callable | None
        ) = None,
        ...
        **kwargs
        ...
        """
        return self(
            kind="kde", bw_method=bw_method, ind=ind, weights=weights, **kwargs
        )
