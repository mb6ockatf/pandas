...
class TestToTimestamp:
    ...
    def test_to_timestamp_preserve_name(self):
        index = period_range(
            freq="Y", start="1/1/2001", end="12/1/2009", name="foo"
        )
    ...
    def test_to_timestamp_pi_combined(self):
        ...
        result = idx.to_timestamp()
        expected = DatetimeIndex(
            ["2011-01-01 00:00", "2011-01-02 01:00"],
            dtype="M8[ns]",
            name="idx",
        )
        tm.assert_index_equal(result, expected)
        ...
        result = idx.to_timestamp(how="E")
        expected = DatetimeIndex(
            ["2011-01-02 00:59:59", "2011-01-03 01:59:59"],
            name="idx",
            dtype="M8[ns]",
        )
        ...
        expected = DatetimeIndex(
            ["2011-01-02 00:00", "2011-01-03 01:00"],
            dtype="M8[ns]",
            name="idx",
        )
...
def test_ms_to_timestamp_error_message():
    ...
    with pytest.raises(
        ValueError, match="for Period, please use 'M' instead of 'MS'"
    ):
        ix.to_timestamp("MS")
