...
class TestDataFrameToCSV:
    ...
    @pytest.mark.parametrize(
        "nrows",
        [2, 10, 99, 100, 101, 102, 198, 199, 200, 201, 202, 249, 250, 251],
    )
    ...
    @pytest.mark.parametrize(
        "nrows",
        [10, 98, 99, 100, 101, 102, 198, 199, 200, 201, 202, 249, 250, 251],
    )
    @pytest.mark.parametrize("ncols", [1, 2, 3, 4])
