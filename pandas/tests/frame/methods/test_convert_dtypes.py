        ...
        expected = pd.DataFrame(
            {
                ...
                "b": pd.Series(
                    ["x", "y", "z"], dtype=f"string[{string_storage}]"
                ),
            }
        )
        ...
        df = pd.DataFrame(
            {
                ...
                "f": pd.Series(
                    pd.date_range("2022", periods=3, tz="UTC").as_unit("s")
                ),
        ...
        expected = pd.DataFrame(
            {
                ...
                "c": pd.arrays.ArrowExtensionArray(
                    pa.array([True, False, None])
                ),
                "d": pd.arrays.ArrowExtensionArray(
                    pa.array([None, 100.5, 200.0])
                ),
