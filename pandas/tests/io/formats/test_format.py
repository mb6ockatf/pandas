...
class TestDataFrameFormatting:
    ...
    def test_repr_truncation_preserves_na(self):
        ...
        with option_context(
            "display.max_rows", 2, "display.show_dimensions", False
        ):
            assert repr(df) == "       a\n0   <NA>\n..   ...\n9   <NA>"
...
class TestSeriesFormatting:
    ...
    @pytest.mark.xfail(
        using_string_dtype(), reason="Fixup when arrow is default"
    )
    ...
    @pytest.mark.xfail(
        using_string_dtype(), reason="change when arrow is default"
    )
...
class TestDatetime64Formatter:
    ...
    def test_datetime64formatter_tz_ms(self):
        x = (
            Series(
                np.array(
                    ["2999-01-01", "2999-01-02", "NaT"], dtype="datetime64[ms]"
                )
            )
