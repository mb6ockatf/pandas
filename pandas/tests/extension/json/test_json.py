...
class TestJSONArray(base.ExtensionTests):
    ...
    def test_series_constructor_scalar_na_with_index(self, dtype, na_value):
        ...
        try:
            # Limit to avoid stack overflow on Windows CI
            sys.setrecursionlimit(100)
            super().test_series_constructor_scalar_na_with_index(
                dtype, na_value
            )
        finally:
            sys.setrecursionlimit(rec_limit)
    ...
    @pytest.mark.xfail(
        reason="fill value is a dictionary, takes incorrect code path"
    )
    ...
    def test_setitem_integer_with_missing_raises(
        ...
        super().test_setitem_integer_with_missing_raises(
    ...
    def test_setitem_with_expansion_dataframe_column(
        ...
        if "full_slice" in request.node.name:
            ...
            request.applymarker(mark)
        super().test_setitem_with_expansion_dataframe_column(
            data, full_indexer
        )
