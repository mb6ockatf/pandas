...
class TestMultiIndexBasic:
    ...
    def test_multiindex_with_datatime_level_preserves_freq(self):
        ...
        df = DataFrame(
            np.random.default_rng(2).standard_normal((14, 2)), index=mi
        )
    ...
    def test_multiindex_repeated_keys(self):
        ...
        tm.assert_series_equal(
            ...
            Series(
                [1, 1, 2, 2], MultiIndex.from_arrays([["a", "a", "b", "b"]])
            ),
        )
    ...
    def test_groupyby_rename_categories_operation_with_multiindex(
        self, operation
    ):
        # GH#51500
        data = DataFrame(
