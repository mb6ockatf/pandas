...
class TestCrosstab:
    ...
    def test_crosstab_normalize(self):
        ...
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize=0),
        ...
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize="index", margins=True),
            row_normal_margins,
        )
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize="columns", margins=True),
            col_normal_margins,
        )
        tm.assert_frame_equal(
            crosstab(df.a, df.b, normalize=True, margins=True),
            all_normal_margins,
        )
