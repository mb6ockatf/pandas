...
class TestBusinessHour:
    ...
    def test_repr(
        ...
        assert (
            repr(offset9) == "<3 * BusinessHours: bh=09:00-13:00,22:00-03:00>"
        )
        assert (
            repr(offset10) == "<-1 * BusinessHour: bh=13:00-17:00,23:00-02:00>"
        )
    ...
    apply_cases = [
        ...
        (
            BusinessHour(start=["09:00", "14:00"], end=["12:00", "18:00"]),
            {
                ...
                datetime(2014, 7, 4, 17, 30, 30): datetime(
                    2014, 7, 7, 9, 30, 30
                ),
            },
        ),
        (
            BusinessHour(
                n=4, start=["09:00", "14:00"], end=["12:00", "18:00"]
            ),
            {
        ...
        (
            BusinessHour(
                n=-1, start=["19:00", "03:00"], end=["01:00", "05:00"]
            ),
            {
                datetime(2014, 7, 1, 17): datetime(2014, 7, 1, 4),
                datetime(2014, 7, 2, 14): datetime(2014, 7, 2, 4),
    ...
    opening_time_cases = [
        ...
        (
            [
                ...
                BusinessHour(
                    n=3, start=["11:15", "15:00"], end=["12:00", "20:00"]
                ),
                BusinessHour(start=["11:15", "15:00"], end=["13:00", "17:00"]),
                BusinessHour(
                    n=2, start=["11:15", "15:00"], end=["12:00", "03:00"]
                ),
                BusinessHour(
                    n=3, start=["11:15", "15:00"], end=["13:00", "16:00"]
                ),
            ],
            {
                datetime(2014, 7, 1, 11): (
