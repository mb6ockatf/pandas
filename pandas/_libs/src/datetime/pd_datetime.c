 ...
 */
static int
convert_pydatetime_to_datetimestruct (PyObject *dtobj,
...
static char *
PyDateTimeToIso (PyObject *obj, NPY_DATETIMEUNIT base, size_t *len)
{
...
static npy_datetime
PyDateTimeToEpoch (PyObject *dt, NPY_DATETIMEUNIT base)
{
  npy_datetimestruct dts;
  int ret;
...
static int
pandas_datetime_exec (PyObject *Py_UNUSED (module))
{
  PyDateTime_IMPORT;
