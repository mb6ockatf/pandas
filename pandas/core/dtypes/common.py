...
def is_integer_dtype(arr_or_dtype) -> bool:
    ...
    return _is_dtype_type(
        ...
        arr_or_dtype,
        lambda typ: isinstance(typ, ExtensionDtype) and typ.kind in "iu",
    )
...
def is_signed_integer_dtype(arr_or_dtype) -> bool:
    ...
    return _is_dtype_type(
        ...
        arr_or_dtype,
        lambda typ: isinstance(typ, ExtensionDtype) and typ.kind == "i",
    )
...
def is_unsigned_integer_dtype(arr_or_dtype) -> bool:
    ...
    return _is_dtype_type(
        ...
        arr_or_dtype,
        lambda typ: isinstance(typ, ExtensionDtype) and typ.kind == "u",
    )
...
def is_numeric_dtype(arr_or_dtype) -> bool:
    ...
    return _is_dtype_type(
        ...
        arr_or_dtype,
        lambda typ: isinstance(typ, ExtensionDtype) and typ._is_numeric,
    )
...
def is_float_dtype(arr_or_dtype) -> bool:
    ...
    return _is_dtype_type(arr_or_dtype, classes(np.floating)) or _is_dtype(
        arr_or_dtype,
        lambda typ: isinstance(typ, ExtensionDtype) and typ.kind in "f",
    )
